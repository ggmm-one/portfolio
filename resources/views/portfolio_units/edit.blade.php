...
<form method="POST" action="{{ route($portfolioUnit->exists? 'portfolio_units.update' : 'portfolio_units.store', ['portfolio_unit' => $portfolioUnit]) }}" class="app-form">
    ...
    @form_select(['control_id' => 'parent_hashid', 'control_label' => 'Parent', 'control_value' => old('parent_hashid', $portfolioUnit->parent_hashid),'select_options' => $availParents, 'disabled' => $portfolioUnit->isRoot()])
