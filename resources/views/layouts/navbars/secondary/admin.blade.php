@section('navbar-secondary')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
        <div class="container-fluid">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSecondaryAdmin"
                aria-controls="navbarSecondaryAdmin" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarSecondaryAdmin">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link"
                            href="{{ route('evaluation_items.index') }}">{{ __('Evaluation') }}</a>
                    <li class="nav-item"><a class="nav-link"
                            href="{{ route('resource_types.index') }}">{{ __('Resource Types') }}</a>
