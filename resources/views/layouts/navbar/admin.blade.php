...
<nav id="app-navbar-section" class="navbar navbar-expand-sm navbar-light bg-light">
    ...
    <div id="app-navbar-section-nav" class="collapsible collapse navbar-collapse navbar-nav">
        <a class="nav-item nav-link" href="{{ route('settings.index') }}">{{ __('Settings') }}</a>
        <a class="nav-item nav-link" href="{{ route('evaluation_items.index') }}">{{ __('Evaluation') }}</a>
        <a class="nav-item nav-link" href="{{ route('resource_types.index') }}">{{ __('Resource Types') }}</a>
        <a class="nav-item nav-link" href="{{ route('users.index') }}">{{ __('Users') }}</a>
        <a class="nav-item nav-link" href="{{ route('roles.index') }}">{{ __('Roles') }}</a>
    </div>
</nav>
@endsection
