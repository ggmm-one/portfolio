...
<ul class="nav nav-tabs bg-light app-nav-section">
    ...
    @if ($portfolioUnit->exists)
    <li class="nav-item"><a href="{{ route('portfolio_units.goals.index', ['portfolio_unit' => $portfolioUnit]) }}" class="nav-link @activeTab('portfolio_units.goals')">{{ __('Strategy and Objectives') }}</a></li>
    <li class="nav-item"><a href="{{ route('portfolio_units.reports.index', ['portfolio_unit' => $portfolioUnit]) }}" class="nav-link @activeTab('portfolio_units.reports')">{{ __('Reports') }}</a></li>
    <li class="nav-item"><a href="{{ route('portfolio_units.links.index', ['portfolio_unit' => $portfolioUnit]) }}" class="nav-link @activeTab('portfolio_units.links')">{{ __('Links') }}</a></li>
