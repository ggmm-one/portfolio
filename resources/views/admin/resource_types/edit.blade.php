...
@section('pagetitle', __($resourceType->exists ? 'Edit Resource Type' : 'Add Resource Type'))
...
<nav class="navbar navbar-light bg-light app-nav-section">
    ...
    @includeWhen($resourceType->exists, 'inc.delete_btn', ['deleteAction' => route('admin.resource_types.destroy', ['resource_type' => $resourceType->pid])])
</nav>
